...
function Navbar() {
  ...
  return (
    <div className="stikcy top-0 flex flex-col sm:flex-row justify-between items-end sm:items-center h-16 w-full border-b-4 px-4 sm:px-10 bg-gray-800  text-white shadow-lg">
